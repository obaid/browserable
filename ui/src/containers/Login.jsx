...
function Login() {
  ...
  const fetchingUserDetails =
    (user.user.status === STATUS.RUNNING || user.user.status === STATUS.IDLE) &&
  ...
  const isSingleUserMode = !!Number(process.env.REACT_APP_SINGLE_USER_MODE);

  console.log("isSingleUserMode", isSingleUserMode);
      ...
      <>
        <header className="container mx-auto py-6 px-4">
          {/* <div className="flex items-center">
            <img src="/browserable-ai.png" alt="Logo" className="h-4" />
          </div> */}
        </header>
        {fetchingUserDetails ? (
          <div></div>
            ...
            {isSingleUserMode && (
              <div className="max-w-lg mx-auto p-2">
                <div className="bg-gray-100 rounded-lg p-8">
                  <h1 className="text-2xl font-extrabold mb-4">Initial Setup</h1>
                  <p className="text-gray-700">
                    Initial setup is in progress. Please reload this page in a
                    minute.
                  </p>
                </div>
              </div>
                ...
                {mode === "enter-otp" ? (
                  <div className="bg-white rounded-lg p-8 drop-shadow-2xl">
                    ...
                    <label
                      ...
                      htmlFor="email"
                    >
                      We've sent a 6-digit code to {email}. The code will expire
                      in 10 minutes.
                    </label>
                    <form>
                  ...
                  <div className="bg-white rounded-lg px-8 pt-6 pb-8 mb-4 drop-shadow-2xl">
                    ...
                    <div className="">
                      ...
                      <p className="text-xs mt-2">
                        We'll send you a magic code (6-digit) for a
